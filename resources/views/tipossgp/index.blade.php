                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('tipossgps.destroy',$tipossgp->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('tipossgps.show',$tipossgp->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('tipossgps.edit',$tipossgp->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
